...
if(isset($_SESSION['role']) && $_SESSION['role'] == 'admin') {
    ...
    $hrefAdmin = 'href="/tpnews/admin/admin.php"';
} else {
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto" role="menu">
        <li class="nav-item <?php echo $activeAccueil; ?>" style="margin-left:30px;">
          <a class="nav-link" href="/tpnews/home/accueil.php" tabindex="1">Accueil</a>
        </li>
        <li class="nav-item <?php echo $activeCreate; ?>">
          <a class="nav-link" href="/tpnews/home/create.php" tabindex="2">Create</a>
        </li>
        ...
        <li class="nav-item dropdown <?php echo $activeProfil; ?>" role="menu">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown" >
              <a class="dropdown-item" href="<?php echo '/tpnews/home/profil.php'; ?>" tabindex="5">Edit Profil</a>
